    ...
    <>
      ...
      <section className="Main">
        <div className="Carrousel">
          {carrousel == 0 ? <img src={carrouselFront} alt="carrouselFront" /> : ""}
          {carrousel == 1 ? <img src={carrouselOne} alt="carrouselFront" /> : ""}
          {carrousel == 2 ? <img src={carrouselTwo} alt="carrouselFront" /> : ""}
