...
function Practices() {
    ...
    useEffect(() => {
        document.title = `Treinos Livres - Calendario ${year} | Fórmula 1 - Statistics`;
    ...
    const [sessions, setSessions] = useState(() => {
        const savedSessions = localStorage.getItem("f1PracticeSessions"); // Changed local storage key
    ...
    // States for Fastest Laps for each practice type
        ...
        async function fetchPracticeData() {
            try {
                ...
                localStorage.setItem(
                    "f1PracticeSessions", // Changed local storage key
                ...
                console.error("Error in fetchPracticeData:", err);
                setLoading(false);
            }
        }
        fetchPracticeData();
